...
export const DEFAULT_SERVICES = {
  ...
  unisex: [
    ...
    { serviceName: "Stylish / Fade Cut", price: "40", durationMinutes: 20, description: "No description" },
    ...
    { serviceName: "Men's Hair Color (Black)", price: "40", durationMinutes: 20, description: "No description" },
    ...
    { serviceName: "Full Face Threading", price: "40", durationMinutes: 20, description: "No description" },
    ...
    { serviceName: "Full Arms Waxing", price: "40", durationMinutes: 20, description: "No description" },
    { serviceName: "Half Legs Waxing", price: "40", durationMinutes: 20, description: "No description" },
    { serviceName: "Full Legs Waxing", price: "40", durationMinutes: 20, description: "No description" },
    { serviceName: "Full Body Waxing", price: "40", durationMinutes: 20, description: "No description" },
    ...
    { serviceName: "Layer Cut", price: "40", durationMinutes: 20, description: "No description" },
    { serviceName: "Step Cut", price: "40", durationMinutes: 20, description: "No description" },
    { serviceName: "Bob / Pixie Cut", price: "40", durationMinutes: 20, description: "No description" },
    { serviceName: "Advance Multi-Layer Cut", price: "40", durationMinutes: 20, description: "No description" },

    // SECTION 5: SKIN CARE & FACIALS
    { serviceName: "Face Cleanup", price: "40", durationMinutes: 20, description: "No description" },
    { serviceName: "Face Bleach", price: "40", durationMinutes: 20, description: "No description" },
    { serviceName: "Face Detan", price: "40", durationMinutes: 20, description: "No description" },
    { serviceName: "Fruit / Herbal Facial", price: "40", durationMinutes: 20, description: "No description" },
    { serviceName: "Gold / Silver Facial", price: "40", durationMinutes: 20, description: "No description" },
    { serviceName: "Diamond / Pearl Facial", price: "40", durationMinutes: 20, description: "No description" },
    { serviceName: "O3+ / Whitening Facial", price: "40", durationMinutes: 20, description: "No description" },
    { serviceName: "Charcoal Mask", price: "40", durationMinutes: 20, description: "No description" },

    // SECTION 6: MANICURE & PEDICURE
    { serviceName: "Manicure (Basic)", price: "40", durationMinutes: 20, description: "No description" },
    { serviceName: "Pedicure (Basic)", price: "40", durationMinutes: 20, description: "No description" },
    { serviceName: "Spa Manicure", price: "40", durationMinutes: 20, description: "No description" },
    { serviceName: "Spa Pedicure", price: "40", durationMinutes: 20, description: "No description" },

    // SECTION 7: HAIR TREATMENTS & CHEMICALS
    { serviceName: "Hair Spa (Basic)", price: "40", durationMinutes: 20, description: "No description" },
    { serviceName: "Hair Spa (Loreal/Matrix)", price: "40", durationMinutes: 20, description: "No description" },
    { serviceName: "Root Touchup (Color)", price: "40", durationMinutes: 20, description: "No description" },
    { serviceName: "Global Hair Color", price: "40", durationMinutes: 20, description: "No description" },
    { serviceName: "Highlights / Streaks", price: "40", durationMinutes: 20, description: "No description" },
    { serviceName: "Smoothening", price: "40", durationMinutes: 20, description: "No description" },
    { serviceName: "Rebonding", price: "40", durationMinutes: 20, description: "No description" },
    { serviceName: "Keratin Treatment", price: "40", durationMinutes: 20, description: "No description" },
    { serviceName: "Botox / Nanoplastia", price: "40", durationMinutes: 20, description: "No description" },
    ...
    { serviceName: "Light / Party Makeup", price: "40", durationMinutes: 20, description: "No description" },
    { serviceName: "Bridal Makeup", price: "40", durationMinutes: 20, description: "No description" }
